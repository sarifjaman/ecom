...
if (isset($_POST['addtocart'])) {
    if (isset($_SESSION['cart'])) {
        ...
        if (in_array($_POST['pdt_name'], $products_name)) {
            echo "<script type='text/javascript'>alert('This product allready added.');</script>";
        } else {
                                ...
                                <table class="shop_table cart-form">
                                    ...
                                    <tbody>
                                                ...
                                                <tr class="cart_item">
                                                    <td class="product-thumbnail" data-title="Product Name">
                                                        <a class="prd-thumb" href="#">
                                                            <figure><img width="113" height="113" src="admin/upload/<?php echo $value['pdt_image']; ?>" alt="shipping cart"></figure>
                                                        </a>
                                                    ...
                                                    <td class="product-quantity" data-title="Quantity">
                                                        <form action="" method="post">
                                                            ...
                                                            <input type="submit" name="remove_product" value="Remove Product" class="btn btn-danger" />
                                                        </form>
                                                    </td>
                                        ...
                                        <?php }
                                            ...
                                            echo "<p class='err-msg'>Your cart is now empty</p>";
                                        } ?>
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                            <div class="shpcart-subtotal-block">
                                <div class="subtotal-line">
                                    <b class="stt-name">Subtotal <span class="sub">(<?php echo $product_item . "items"; ?>)</span></b>
