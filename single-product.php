                                        ...
                                        <div class="sumary-product single-layout">
                                            <div class="media">
                                                <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                                                    <li><img src="admin/upload/<?php echo $pro['pdt_image']; ?>" alt="" width="500" height="500"></li>
                                                </ul>
                                            </div>
                                            <div class="product-attribute">
                                                ...
                                                <span class="sku"><?php echo $pro['pdt_id']; ?></span>
                                            ...
                                            <div class="action-form">
                                                ...
                                                <div class="buttons">
                                                    ...
                                                    <input type="submit" name="addtocart" class="btn btn-block add-to-cart-btn" value="Add To Cart" />
                                                    <p class="pull-row">
                                                    ...
                                                    <li class="product-item">
                                                        <div class="contain-product layout-default">
                                                            <div class="product-thumb">
                                                                <a href="single-product.php?status=singleproduct&&id=<?php echo $rpro['pdt_id']; ?>" class="link-to-product">
                                                                    <img src="admin/upload/<?php echo $rpro['pdt_image']; ?>" alt="dd" width="270" height="270" class="product-thumnail">
                                                                </a>
                                                            </div>
                                                            <div class="info">
                                                                <b class="categories"><?php echo $rpro['ctg_name']; ?></b>
                                                                <h4 class="product-title"><a href="single-product.php?status=singleproduct&&id=<?php echo $rpro['pdt_id']; ?>" class="pr-name"><?php echo $rpro['pdt_name']; ?></a></h4>
                                                                <div class="price">
