                                                    ...
                                                    <div class="contain-product layout-default">
                                                        <div class="product-thumb">
                                                            <a href="single-product.php?status=singleproduct&&id=<?php echo $pro['pdt_id']; ?>" class="link-to-product">
                                                                <img src="admin/upload/<?php echo $pro['pdt_image']; ?>" alt="dd" width="270" height="270" class="product-thumnail">
                                                            </a>
                                                        </div>
                                                        <div class="info">
                                                            ...
                                                            <div class="slide-down-box">
                                                                ...
                                                                <div class="buttons">
                                                                    ...
                                                                    <a href="single-product.php?status=singleproduct&&id=<?php echo $pro['pdt_id']; ?>" class="btn compare-btn"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
